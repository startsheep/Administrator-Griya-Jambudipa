...
class TransactionController extends Controller
{
    public function pdf()
    {
        return Excel::download(new TransactionExport, date("Y_m_d_His") . '_REKAP_DATA_TRANSAKSI.pdf');
    }

    public function excel()
    {
        return Excel::download(new TransactionExport, date("Y_m_d_His") . '_REKAP_DATA_TRANSAKSI.xlsx');
    }
