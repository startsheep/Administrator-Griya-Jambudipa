          ...
          <form class="form-row">
            <div class="form-group col-lg-6">
              ...
              <!-- <input
                            ...
                            /> -->
              <select class="form-control" v-model="kavling.block">
                <option selected disabled value="">Pilih Blok Kavling</option>
    ...
    update() {
      ...
      const url = [
        ...
        this.kavling.id,
        {
          ...
          house_type: this.kavling.houseType,
