<template>
    <section class="section">
        <div class="section-header">
            <h4>
                Perincian Harga Dasar {{ isBuilding ? "Bangunan" : "Tanah" }}
            </h4>
        </div>
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                <div
                                    v-if="
                                        isCreateCategories || isEditCategories
                                    "
                                    class="form-group"
                                >
                                ...
                                <button
                                    v-else
                                    @click="
                                        isCreateCategories = !isCreateCategories
                                    "
                                    class="btn btn-primary"
                                >
                                    Tambah Perincian
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td colspan="6" class="align-middle">
                                            ...
                                            <div
                                                class="collapse mx-2"
                                                :id="'child' + categories.id"
                                            >
                                                <div
                                                    v-for="(
                                                        child, index
                                                    ) in categories.basicPrice"
                                                    :key="child"
                                                >
                                                    <div
                                                        class="row ml-3 d-flex justify-content-between align-items-center my-2"
                                                    >
                                                        <div class="col-3">
                                                            <Media>
                                                                <template
                                                                ...
                                                                >
                                                                    <i
                                                                        ...
                                                                        :data-target="
                                                                            ...
                                                                            'children'
                                                                        "
                                                                        class="btn fas fa-square-plus fa-lg sortable mr-1"
                                                                    ></i>
