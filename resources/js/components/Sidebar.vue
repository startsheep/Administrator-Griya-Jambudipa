      ...
      <ul class="sidebar-menu">
        ...
        <li class="nav-item">
          <router-link to="/employees" class="nav-link"
            ...
            ><span>Data Pegawai</span></router-link
          >
        </li>
        <li class="nav-item">
          <router-link to="/customers" class="nav-link"
            ><i class="fa-solid fa-people-roof"></i
            ><span>Data Customer</span></router-link
          >
        </li>
        <li class="nav-item">
          ...
          <ul class="dropdown-menu">
            <li>
              <router-link
                ...
                to="/jobs/house"
                ><i class="fa-solid fa-house"></i>Borongan Rumah</router-link
              >
            </li>
            <li>
              <router-link
                ...
                style="background-color: #141d3e; color: white"
                to="/jobs/facility"
                ><i class="fa-solid fa-stethoscope"></i>Fasilitas Umum</router-link
              >
            </li>
          </ul>
        </li>
