                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ url('') }}"
                                ...
                                <img src="{{ $profile->logo ? url('storage/' . $profile->logo) : asset('assets/images/logo.png') }}"
                                    class="logo" alt="Griya Jambudipa"
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ date('Y') }} Griya Jambudipa. All rights reserved.</p>
